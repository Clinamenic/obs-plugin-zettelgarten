...
4. Workspace Scaffolding Directories
   - .cursor/ for Cursor
   - .claude/ and CLAUDE.md for Claude
   - .workspace/ for general workspace-specific configuration and development scripts and resources, including .workspace/temp/ for temporary resources
